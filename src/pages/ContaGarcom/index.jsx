...
import './ContaGarcom.css';
import { getItensEmAndamento, getItensEntregue, updateItemPedido } from '../../services/funcionario-requests';
  ...
  return (
    <div className="view-container">
      <div className="tabelas-container">
              ...
              {itensEmAndamento.map((item, index) => (
                <tr key={item.id} style={index < 5 ? { fontSize: '1.5em', fontWeight: 'bold', color: 'blue' } : null}>
                  ...
                  <td data-label="Entregar">
                    <button onClick={() => entregarItemPedido(item.id)}>
                      <FaCheck />
                    </button>
                  </td>
                </tr>
        ...
        <div className="tabela-itens-entregues">
